    ...
    <div className="bg-clinical-white min-h-screen">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-12">
          ...
          <h1 className="font-heading text-3xl sm:text-4xl font-bold text-clinical-charcoal tracking-tight mb-6">Terms & Conditions</h1>
        </div>
        <div className="space-y-8 text-clinical-muted leading-relaxed">
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-clinical-charcoal mb-3">5. Payment</h2>
