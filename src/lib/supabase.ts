...
export const products = [
  {
    ...
    variants: [
      ...
      },
      {
        ...
        label: 'Circulation Support Device + Compression Socks — Starter',
        detail: '1 Device + Compression Support Socks (1 Pair)',
        price: 49.76,
        section: 'Device + Support Bundle Offers',
        isBundle: true,
        deviceCount: 1,
        image: '/images/products/device-1x-socks-combo.jpg',
      },
      {
        id: 'device-standard-support',
        label: 'Circulation Support Device + Compression Socks — Standard',
        detail: '1 Device + Compression Support Socks (1 Pair)',
        price: 53.45,
        section: 'Device + Support Bundle Offers',
        isBundle: true,
      ...
      },
      {
        ...
        label: 'Circulation Support Device + Compression Socks — Extended',
        detail: '1 Device + Compression Support Socks (1 Pair)',
        price: 54.95,
        section: 'Device + Support Bundle Offers',
        isBundle: true,
      ...
      },
      {
        ...
        label: '2-Device + Compression Socks Bundle — Starter',
        detail: '2 Devices + Compression Support Socks (1 Pair)',
        price: 87.64,
        section: 'Multi-Device Value Offers',
        isBundle: true,
        deviceCount: 2,
        image: '/images/products/device-2x-socks-combo.jpg',
      },
      {
        id: '2-device-standard-support-bundle',
        label: '2-Device + Compression Socks Bundle — Standard',
        detail: '2 Devices + Compression Support Socks (1 Pair)',
        price: 87.76,
        section: 'Multi-Device Value Offers',
        isBundle: true,
      ...
      },
      {
        ...
        label: '2-Device + Compression Socks Bundle — Extended',
        detail: '2 Devices + Compression Support Socks (1 Pair)',
        price: 94.82,
        section: 'Multi-Device Value Offers',
        isBundle: true,
